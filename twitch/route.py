...
from twitch.forms import LoginForm,RegisterForm,EditProfileForm,Tweetform,PasswdResetRequestForm,PasswdResetForm
from twitch.models.user import User,load_user
from twitch.models.tweet import Tweet
from twitch import db

from twitch.email import send_email
...
def index():
    ...
    return render_template('index.html',tweets=tweets.items,next_url=next_url,prev_url=prev_url,form=form )
...
def login():
    ...
    if form.validate_on_submit():
        ...
        login_user(u,remember=form.remeber_me.data)
